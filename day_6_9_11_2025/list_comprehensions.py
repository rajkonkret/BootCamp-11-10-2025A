...
modifed_number = [num * 2 if num % 2 == 0 else num for num in numbers]
print(f"Zmodyfikowane: {modifed_number}")  # Zmodyfikowane: [1, 4, 3, 8, 5]
...
print(wynik)  # [0, 36, 72, 108, 144, 180]
